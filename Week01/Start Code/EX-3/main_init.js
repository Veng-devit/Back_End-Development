...
raceResultService.addRaceResult(new RaceResult("participant2", "run",  Duration.fromMinutesAndSeconds(3, 15)));
raceResultService.addRaceResult(new RaceResult("participant3", "run",  Duration.fromMinutesAndSeconds(4, 15)));
